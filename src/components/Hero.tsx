...
export const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16 animate-fade-in">
      ...
      <div className="absolute inset-0 animate-morphing-gradient">
        ...
        {floatingIcons.map(({
          ...
          <div key={index} className={`absolute ${position} text-cyan-400/30 ${animation} hover:text-cyan-400/60 hover:scale-150 transition-all duration-500 cursor-pointer animate-rotate-3d`} style={{
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(30)].map((_, i) => (
            <div key={i} className="absolute w-1 h-1 bg-cyan-400 rounded-full opacity-30 animate-ping hover:animate-bounce" style={{
      ...
      <div className="text-center z-10 px-4 max-w-4xl mx-auto animate-slide-in-elastic">
        ...
        <div className="mb-8 relative group animate-bounce-in">
          <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 p-2 animate-glow-pulse hover:animate-rotate-3d hover:scale-125 transition-all duration-1000 shadow-2xl shadow-cyan-500/50">
            <div className="w-full h-full rounded-full overflow-hidden bg-slate-800 border-4 border-slate-700 relative group-hover:border-cyan-400 transition-all duration-500">
              <img
                src="https://i.postimg.cc/256yPM7r/Bharath.jpg"
                alt="Bharath Kumar S"
                className="w-full h-full object-cover rounded-full group-hover:scale-110 transition-transform duration-700 group-hover:brightness-110"
              />
        ...
        <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-fade-in hover:scale-110 hover:rotate-1 transition-all duration-700 cursor-default filter drop-shadow-2xl animate-morphing-gradient" style={{ backgroundSize: '400% 400%' }}>
          Bharath Kumar S
        </h1>
