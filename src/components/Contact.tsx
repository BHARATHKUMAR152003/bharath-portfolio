...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 animate-slide-in-view opacity-0 transform translate-y-20 transition-all duration-1000">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-5xl font-bold text-center mb-20 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent animate-on-scroll opacity-0 transform translate-y-10 transition-all duration-800 animate-morphing-gradient" style={{ backgroundSize: '400% 400%' }}>
          Let's Connect
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="slideshow-item" style={{ animationDelay: '0.3s' }}>
            <h3 className="text-3xl font-bold text-white mb-8 hover:text-cyan-300 transition-colors duration-300 animate-glow-pulse">Get In Touch</h3>
            <p className="text-gray-300 mb-10 leading-relaxed hover:text-gray-200 transition-colors duration-300 text-lg">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <a
                  ...
                  className="flex items-center gap-5 p-6 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-500 group hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/10 animate-on-scroll opacity-0 transform translate-x-[-30px] hover:-translate-y-2 hover:rotate-1 animate-glow-pulse"
          ...
          <div className="slideshow-item" style={{ animationDelay: '1s' }}>
            <h3 className="text-3xl font-bold text-white mb-8 hover:text-cyan-300 transition-colors duration-300 animate-glow-pulse">Send Message</h3>
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="animate-on-scroll opacity-0 transform translate-y-10 transition-all duration-500" style={{ animationDelay: '1.2s' }}>
                <label className="block text-gray-300 mb-3 hover:text-cyan-300 transition-colors duration-300 font-semibold text-lg">Name</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div className="animate-on-scroll opacity-0 transform translate-y-10 transition-all duration-500" style={{ animationDelay: '1.4s' }}>
                <label className="block text-gray-300 mb-3 hover:text-cyan-300 transition-colors duration-300 font-semibold text-lg">Email</label>
                <input
                  type="email"
              ...
              <div className="animate-on-scroll opacity-0 transform translate-y-10 transition-all duration-500" style={{ animationDelay: '1.6s' }}>
                <label className="block text-gray-300 mb-3 hover:text-cyan-300 transition-colors duration-300 font-semibold text-lg">Message</label>
                <textarea
